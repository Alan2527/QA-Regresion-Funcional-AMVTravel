...
def test_crear_orden_cobro(driver):
    ...
    with allure.step("1. Login en el BackOffice"):
        ...
        # Inyección limpia de credenciales usando esperas explícitas
    ...
    with allure.step("4. Seleccionar Referencia de Pago y Moneda (USD)"):
        # Selección de Referencia de Pago usando la clase Select por legibilidad
    ...
    with allure.step("5. Buscar y seleccionar Cliente en el modal"):
        ...
        # Simulación de Hover para desplegar/enfocar el buscador del modal
        ...
        # Filtrado de cliente e imputación
        ...
        # Selección de la fila mapeada en la grilla del modal
    ...
    with allure.step("6. Completar Tipo de Caja, Detalle y Monto"):
        ...
        allure.attach(driver.get_screenshot_as_png(), name="Datos_Orden_Completados", attachment_type=allure.attachment_type.PNG)[cite: 2]
    ...
    with allure.step("8. Realizar imputación de saldos (Asignar Total)"):
        ...
        allure.attach(driver.get_screenshot_as_png(), name="Imputacion_Saldos_OK", attachment_type=allure.attachment_type.PNG)[cite: 2]

    # ==========================================
    # 9. FLUJO DE APROBACIÓN FINAL
    # ==========================================
    with allure.step("9. Procesar aprobación e ingresar Fecha de Recibo"):
        # Primera etapa de aprobación
        wait.until(EC.element_to_be_clickable((By.ID, "btnApprove"))).click()[cite: 1]
        
        # Apertura de datepicker e imputación de fecha
        ...
        # Aprobación definitiva del documento contable
        ...
        allure.attach(driver.get_screenshot_as_png(), name="Orden_Aprobada_Final", attachment_type=allure.attachment_type.PNG)[cite: 2]
